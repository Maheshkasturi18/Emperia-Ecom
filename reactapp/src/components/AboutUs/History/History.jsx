    ...
    return (
      <section className="his-bg">
        <div className="hist-head">
          <h1 className="hist-head-name fw-bold"> Our History</h1>
        </div>
        ...
        <div className="container py-4 lh-lg">
          <p>
            ...
            sectors.{" "}
            <b>
              Empire Industries Limited, with its repertoire of businesses, has
              established a strong market presence in the manufacture and
              marketing of machine tools, industrial equipment, glass bottles,
              business centers, integrated industrial and residential townships,
              frozen foods and vending machines.
            </b>
          </p>
          <p>
            ...
            <b>
              {" "}
              Grabbit + was launched with the vision to be the most preferred
              vending solution provider by making world-class, quality vending
              machines for corporate offices in India.
            </b>
          </p>
          ...
          <div className="row py-3">
            <div className="col-lg-6">
              <p>
                ...
                inaccessible.<b> Grabbit+</b> saw this as an opportunity to
                contribute to the lives of many. <b>Grabbit+</b> not only
                offered vending services during this time but also assisted
                institutions across the country in maintaining hygiene and
                creating a healthier, better and safer environment for its
                employees and visitors by making a range of health and hygiene
                solutions expediently available. This marked the beginning of
                the Health & Hygiene vertical, which is known for developing
                high-quality products and providing world-class services to its
                customers. <b>Grabbit+</b>
            ...
            <div className="col-lg-6 " data-aos="fade-left">
              <img src="images/history-img.jpg" alt="" className="img-fluid" />
            </div>
          </div>
